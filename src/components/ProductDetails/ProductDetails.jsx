...
const ProductDetails = () => {
    ...
    const {product_title, product_image, rating, category, price, description, specification} = product;
    return (
        <div className="relative">
            ...
            <div className="flex justify-center items-center border-2 mt-[-150px] rounded-2xl mx-24 p-8 bg-white">
                ...
                <div className="space-y-3">
                    ...
                    <ol>
                        {
                            specification.map(spec => <li className="ml-3">{spec}</li>)
                        }
                    </ol>
                    ...
                    <div className="flex space-x-2">
                        ...
                        <button className="text-2xl"><FaRegHeart></FaRegHeart></button>
                    </div>
                </div>
            </div>
        </div>
